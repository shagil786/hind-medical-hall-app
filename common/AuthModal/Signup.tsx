...
export default function Signup({ step, onNextStep, onPrevStep, onModeChange, onClose }: SignupProps) {
    ...
    <div className="space-y-4">
      ...
      {step === 1 && (
        <form onSubmit={handleVerification} className="space-y-4">
          ...
          <Button variant="outline" onClick={onPrevStep} className="w-full mt-2">
            Back
          </Button>
        </form>
      )}
